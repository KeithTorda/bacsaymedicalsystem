...
@section('content')
    ...
    <div class="official-header">
        ...
        <div class="header-center-details">
            ...
            <div class="header-brand-line">
                <img src="{{ asset('assets/img/bacsay-seal.jpg') }}" class="rounded-circle" style="width: 18px; height: 18px; object-fit: cover;" alt="Icon">
        ...
        <div class="header-seal-right">
            <img src="{{ asset('assets/img/bacsay-seal.jpg') }}" class="bacsay-seal rounded-circle" style="object-fit: cover;" alt="Barangay Bacsay Seal">
    ...
    <div class="official-footer">
        <div class="footer-brand">
            <img src="{{ asset('assets/img/bacsay-seal.jpg') }}" class="rounded-circle" style="width: 14px; height: 14px; object-fit: cover;">
